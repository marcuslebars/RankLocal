...
export const PACKAGES: Record<string, PackageConfig> = {
  ...
  growth_starter: {
    key: "growth_starter",
    label: "Growth Plan — Starter",
    category: "growth",
    price: 69700,
    priceDisplay: "$697/mo",
    onboardingType: "growth",
    headline: "Let's Launch Your Monthly Growth Plan",
    subheadline: "Tell us about your business so we can begin managing your local visibility and growth each month.",
    successHeadline: "You're all set.",
    successMessage: "We'll be in touch shortly to kick off your monthly growth plan.",
    requiredFields: [
      { name: "businessName", label: "Business Name", required: true, type: "text", placeholder: "Your business name" },
      { name: "primaryLocation", label: "Primary Location / Service Area", required: true, type: "text", placeholder: "e.g., Toronto, ON" },
      { name: "contactName", label: "Contact Name", required: true, type: "text", placeholder: "Your full name" },
    ...
    optionalFields: [
      { name: "websiteUrl", label: "Website URL", required: false, type: "url", placeholder: "https://yourwebsite.com" },
      { name: "googleBusinessProfile", label: "Google Business Profile Link", required: false, type: "url", placeholder: "https://maps.google.com/..." },
      { name: "mainGoal", label: "Main Goal", required: false, type: "textarea", placeholder: "What do you want this monthly plan to achieve?" },
      { name: "notes", label: "Additional Notes", required: false, type: "textarea", placeholder: "Anything else we should know?" },
    ],
    internalOrderType: "growth_starter",
  },

  growth_growth: {
    key: "growth_growth",
    label: "Growth Plan — Growth",
    category: "growth",
    price: 149700,
    priceDisplay: "$1,497/mo",
    onboardingType: "growth",
    headline: "Let's Build Your Growth Engine",
    subheadline: "Tell us about your business so we can begin executing your monthly SEO, ads, and growth strategy.",
    successHeadline: "You're all set.",
    successMessage: "We'll be in touch shortly to kick off your growth engine plan.",
    requiredFields: [
      { name: "businessName", label: "Business Name", required: true, type: "text", placeholder: "Your business name" },
      { name: "primaryLocation", label: "Primary Location / Service Area", required: true, type: "text", placeholder: "e.g., Toronto, ON" },
      { name: "contactName", label: "Contact Name", required: true, type: "text", placeholder: "Your full name" },
    ...
    optionalFields: [
      { name: "websiteUrl", label: "Website URL", required: false, type: "url", placeholder: "https://yourwebsite.com" },
      { name: "googleBusinessProfile", label: "Google Business Profile Link", required: false, type: "url", placeholder: "https://maps.google.com/..." },
      { name: "targetServices", label: "Priority Services / Keywords", required: false, type: "textarea", placeholder: "Which services or keywords matter most?" },
      { name: "currentAds", label: "Current Ads or Marketing Channels", required: false, type: "textarea", placeholder: "What marketing are you already running?" },
      { name: "notes", label: "Additional Notes", required: false, type: "textarea", placeholder: "Anything else we should know?" },
    ],
    internalOrderType: "growth_growth",
  },

  growth_dominance: {
    key: "growth_dominance",
    label: "Growth Plan — Dominance",
    category: "growth",
    price: 300000,
    priceDisplay: "$3,000/mo",
    onboardingType: "growth",
    headline: "Let's Build Your Local Dominance Plan",
    subheadline: "Tell us about your locations, offers, and growth priorities so we can execute at full scale.",
    successHeadline: "You're all set.",
    successMessage: "We'll be in touch shortly to kick off your dominance plan.",
    requiredFields: [
      { name: "businessName", label: "Business Name", required: true, type: "text", placeholder: "Your business name" },
      { name: "primaryLocation", label: "Primary Location / Service Area", required: true, type: "text", placeholder: "e.g., Toronto, ON" },
      { name: "contactName", label: "Contact Name", required: true, type: "text", placeholder: "Your full name" },
    ...
    optionalFields: [
      { name: "websiteUrl", label: "Website URL", required: false, type: "url", placeholder: "https://yourwebsite.com" },
      { name: "locations", label: "Locations to Target", required: false, type: "textarea", placeholder: "List the cities, service areas, or locations you want to grow." },
      { name: "monthlyAdSpend", label: "Monthly Ad Spend", required: false, type: "text", placeholder: "e.g., $5,000/month" },
      { name: "competitors", label: "Top Competitors", required: false, type: "textarea", placeholder: "Who do you want to outrank locally?" },
      { name: "notes", label: "Additional Notes", required: false, type: "textarea", placeholder: "Anything else we should know?" },
    ],
    internalOrderType: "growth_dominance",
  },
